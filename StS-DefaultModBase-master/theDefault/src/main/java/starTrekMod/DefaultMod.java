...
import starTrekMod.cards.*;
import starTrekMod.characters.TheDefault;
import starTrekMod.events.IdentityCrisisEvent;
import starTrekMod.potions.PlaceholderPotion;
import starTrekMod.relics.BottledPlaceholderRelic;
import starTrekMod.relics.DefaultClickableRelic;
import starTrekMod.relics.PlaceholderRelic;
import starTrekMod.relics.PlaceholderRelic2;
import starTrekMod.util.IDCheckDontTouchPls;
import starTrekMod.util.TextureLoader;
import starTrekMod.variables.DefaultCustomVariable;
import starTrekMod.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String MODNAME = "starTrekMod";
    private static final String AUTHOR = "JeanRean"; // And pretty soon - You!
    private static final String DESCRIPTION = "A star trek mod because I'm a nerd.";
    ...
    private static final String ATTACK_DEFAULT_GRAY = "starTrekModResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "starTrekModResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "starTrekModResources/images/512/bg_power_default_gray.png";

    private static final String ENERGY_ORB_DEFAULT_GRAY = "starTrekModResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "starTrekModResources/images/512/card_small_orb.png";

    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "starTrekModResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "starTrekModResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "starTrekModResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "starTrekModResources/images/1024/card_default_gray_orb.png";

    // Character assets
    private static final String THE_DEFAULT_BUTTON = "starTrekModResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "starTrekModResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "starTrekModResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "starTrekModResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "starTrekModResources/images/char/defaultCharacter/corpse.png";

    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "starTrekModResources/images/Badge.png";

    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "starTrekModResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "starTrekModResources/images/char/defaultCharacter/skeleton.json";
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("stMod") // ${project.artifactId}
