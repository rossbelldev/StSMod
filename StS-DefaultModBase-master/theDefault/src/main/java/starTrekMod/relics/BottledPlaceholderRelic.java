...
import starTrekMod.patches.relics.BottledPlaceholderField;
import starTrekMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static starTrekMod.DefaultMod.makeRelicOutlinePath;
import static starTrekMod.DefaultMod.makeRelicPath;
